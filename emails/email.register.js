  ...
  return {
    ...
    html: `
        ...
        <div class="Unsubscribe--addressLine">
          ...
          >
          <a href="${config.get("baseUrl")}" target="_blank" style="font-family:sans-serif;text-decoration:none;">
            Contact.me team
          </a>
        ...
        <p style="font-size:12px; line-height:20px;">
          <a class="Unsubscribe--unsubscribeLink" href="${config.get("baseUrl")}" target="_blank" style="font-family:sans-serif;text-decoration:none;">
            Unsubscribe
          </a>
<!--          - -->
